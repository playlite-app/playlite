        ...
        nav: [
          { text: 'Início', link: '/pt-BR/' },
          {
            ...
            items: [
              ...
              { text: 'Primeiros passos', link: '/pt-BR/guide/getting-started' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Sistema de Recomendação', link: '/pt-BR/dev/recommendation-system' },
              { text: 'Filtragem Colaborativa Offline', link: '/pt-BR/dev/collaborative-filtering' },
              { text: 'Desenvolvimento Assistido por IA', link: '/pt-BR/dev/ai-assisted-development' },
            ],
          },
          {
            text: 'Projeto',
            items: [
              { text: 'Documentação no GitHub', link: '/pt-BR/dev/project-docs' },
            ],
          },
          {
            text: 'API Reference',
            items: [
              { text: 'Backend (Rust Docs)', link: '/api/rust/game_manager_lib/index.html', target: '_blank' },
              { text: 'Frontend (TypeDoc)', link: '/api/frontend/index.html', target: '_blank' },
            ],
          },
          { text: 'Releases', link: 'https://github.com/Alan-oliveir/game_manager/releases' },
        ],
        sidebar: {
          '/pt-BR/guide/': [
            {
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Listas (Playlist/Wishlist)', link: '/pt-BR/guide/pages/lists' },
        ...
        nav: [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Recommendation System', link: '/en/dev/recommendation-system' },
              { text: 'Offline Collaborative Filtering', link: '/en/dev/collaborative-filtering' },
              { text: 'AI-Assisted Development', link: '/en/dev/ai-assisted-development' },
            ],
          },
          {
            text: 'Project',
          ...
          '/en/guide/': [
            ...
            },
            {
              ...
              items: [
                ...
                { text: 'Lists (Playlist/Wishlist)', link: '/en/guide/pages/lists' },
