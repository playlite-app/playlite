        ...
        <TooltipTrigger asChild>
          <Button
            ...
            className={`shrink-0 transition-colors ${
              hideAdult
                ? 'bg-green-500/10 text-green-500 hover:bg-green-500/20 hover:text-green-600' // Modo Seguro (Filtrado)
                : 'text-muted-foreground hover:bg-red-500/10 hover:text-red-500' // Modo Padrão (Tudo visível)
            }`}
          >
