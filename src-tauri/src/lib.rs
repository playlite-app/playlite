...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::plataforms::scanner::scan_games_folder,
            commands::plataforms::scanner::add_game_from_scan,
            commands::plataforms::scanner::add_games_from_scan,
            commands::plataforms::steam::import_steam_library,
            commands::plataforms::epic::epic_login,
            commands::plataforms::epic::epic_logout,
            commands::plataforms::epic::epic_is_authenticated,
            commands::plataforms::epic::import_epic_games,
            commands::plataforms::heroic::import_heroic_games,
            commands::plataforms::ubisoft::import_ubisoft_games,
            commands::plataforms::legacy::import_legacy_games,
            commands::plataforms::gog::gog_login,
